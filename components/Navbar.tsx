...
export default function Navbar() {
    ...
    return (
        ...
        >
            <div className="font-heading text-xl tracking-[0.2em] font-bold text-white uppercase drop-shadow-md">
                <span className="text-accent-ember">DHOLAKPUR</span> CHRONICLES
            </div>
